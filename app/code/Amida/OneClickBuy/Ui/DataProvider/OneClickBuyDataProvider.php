...
namespace Amida\OneClickBuy\Ui\DataProvider;

use Amida\OneClickBuy\Api\Data\OneClickBuyInterface;
use Amida\OneClickBuy\Query\OneClickBuy\GetListQuery;
 ...
 */
class OneClickBuyDataProvider extends DataProvider
{
    /**
     * @var GetListQuery
     */
    ...
    public function getSearchResult()
    {
        ...
        return $this->searchResultFactory->create(
            ...
            $searchCriteria,
            OneClickBuyInterface::ENTITY_ID
        );
    }
    ...
    public function getData(): array
    {
        ...
        foreach ($this->loadedData['items'] as $item) {
            $itemsById[(int)$item[OneClickBuyInterface::ENTITY_ID]] = $item;
        }

        if ($id = $this->request->getParam(OneClickBuyInterface::ENTITY_ID)) {
